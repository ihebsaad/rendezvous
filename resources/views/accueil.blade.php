...
<div class="container padding-top-70 padding-bottom-30" style="background: black;">
    <div class="row" style="background: black;">
        ...
        <div class="col-md-12">
            <?php  $User= auth()->user(); 
            $listingsM=\App\User::where('user_type','prestataire') ->where(function($q){        
                               $q->where('pays','Martinique')
                               ->orWhere('adresse','like','%Martinique%');
                                })->get();
                $nbmar=count($listingsM); if($nbmar >=3) {?>
            <center><h3>Martinique</h3></center><br>
          ...
          $reviews= \App\Review::where('prestataire',$listing->id)->get();
            ...
            <br><br>
             <?php }  ?>
            <?php  $User= auth()->user(); 
            $listingspf=\App\User::where('user_type','prestataire') ->where(function($q){        
                               $q->where('pays','France')
                               ->orWhere('adresse','like','%France%')->orWhere('adresse','like','%Paris%');
                                })->get();
                $nbpf=count($listingspf); if($nbpf >=3) {?>
            <center><h3>Paris,France</h3></center>
            <br>
             <div class="simple-slick-carousel dots-nav">
                           <?php
          ...
          $reviews= \App\Review::where('prestataire',$listing->id)->get();
            ...
            <br><br>
              <?php }  ?>
             <?php  $User= auth()->user(); 
            $listingsgc=\App\User::where('user_type','prestataire') ->where(function($q){        
                               $q->where('pays','Guyane Française')
                               ->orWhere('adresse','like','%Guyane Française%')->orWhere('adresse','like','%Cayenne%');
                                })->get();
                $nbgc=count($listingsgc); if($nbgc >=3) {?>
            <center><h3>Guyane Française, Cayenne</h3></center>
            <br>
             <div class="simple-slick-carousel dots-nav">
          ...
          $reviews= \App\Review::where('prestataire',$listing->id)->get();
            ...
            <?php } //}  //foreach $listings  ?>
            <?php  $User= auth()->user(); 
            $listingsgd=\App\User::where('user_type','prestataire') ->where(function($q){        
                               $q->where('pays','Guadaloupe')
                               ->orWhere('adresse','like','%Guadaloupe%');
                                })->get();
                $nbgd=count($listingsgd); if($nbgd >=3) {?>
            <center><h3>Guadaloupe</h3></center>
            <br>
             <div class="simple-slick-carousel dots-nav">
          ...
          $reviews= \App\Review::where('prestataire',$listing->id)->get();
            ...
            <!-- Autres prestataires-->
             <?php 
             if($nbmar<3 && $nbgd<3 && $nbgc<3 && $nbpf<3) { 
            $listings=\App\User::where('user_type','prestataire')->get();
                $nbautres=count($listings); if($nbautres >=3) {?>
          ...
          $reviews= \App\Review::where('prestataire',$listing->id)->get();
            ...
            <?php }   ?>
        <?php }  // fin if nbmar nbgc nbgd nbpf ?>
        </div><!-- fin col 12 -->
