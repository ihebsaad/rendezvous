     ...
     <table class="table table-striped table-hover" id="mytable" style="width:100%">
      ...
      <th class="no-sort">Actions</th> 
            ...
            @foreach($alertes as $alerte)
                <tr> 
					<td><?php echo   date('d/m/Y H:i', strtotime($alerte->created_at ))  ;?></td>
                     <td> <?php echo $alerte->titre ;?> </td>
                     <td> <?php echo $alerte->details;?> </td>
                    <td>  
           <a  class="delete fm-close"  onclick="return confirm('Êtes-vous sûrs ?')"  href="{{action('AlertesController@remove', $alerte->id)}}"><i class="fa fa-remove"></i></a>
