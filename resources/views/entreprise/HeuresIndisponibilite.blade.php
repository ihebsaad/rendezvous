                                    ...
                                    <table id="pricing-list-container">
                                        ...
                                        <tr class="pricing-list-item pattern">
                                             <td>
                                                ...
                                                <div class="fm-input pricing-ingredients"><input style="pointer-events: none; opacity: 0.9;" disabled=""  type="text" placeholder="Date de début"  value="<?php $date=new DateTime($pi->date_debut) ;echo $date->format('d/m/Y H:i');?>"/></div>
                                                <div class="fm-input pricing-ingredients"><input style="pointer-events: none; opacity: 0.9;" disabled=""  type="text" placeholder="Date de fin" value="<?php $date=new DateTime($pi->date_fin) ;echo $date->format('d/m/Y H:i');?> "/></div>
