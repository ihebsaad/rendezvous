<?php 
 ...
 <!-- Footer -->
  <div id="footer" class="footer_sticky_part" style="padding-top:150px;padding-bottom: 180px;margin-bottom: 0px"> 
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="footer_copyright_part" ><br><br>Copyright © 2021 Tous droits réservés - par eSolutions </div>
        </div>
      </div>
    </div>
  </div> 