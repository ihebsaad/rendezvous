...
">
    ...
    width: fit-content;">
                ...
                <ul class="footer-links">
                    ...
                    <li><a style=" width: 275px; "class="aa" href="{{route('inscription')}}" >Vous êtes prestataire de service ?</a></li>
                    <li><a class="" href="{{route('inscriptionclient')}}" style="    width: 136px;">Je suis un client</a></li> 
                    @else
