                ...
                <div id="add-listing">
                    ...
                    <div class="add-listing-section">
                        ...
                        <div class="add-listing-headline">
                          <?php if ($acompte) {  ?>
                           <h3><i class="im im-icon-Credit-Card"></i>Paiement de l'acompte <span style="float: right;margin: 5px">{{$valAcompte}} €</span></h3>
...
<script>
  //alert("{{ $Res }}");
  //pk_live_51Hbt14Go3M3y9uW5wKqzuQN968NPlPtwzB5UZFzLqTtNAZxoU43qINNnPR7cAO8j1XKoZZ1QZyGkYLHvQjOc5U3c00K0ZoDEMa
