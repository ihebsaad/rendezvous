  ...
  <div class="parallax" data-background="public/images/apropos.jpg"> 
   ...
   <div class="container">
	  ...
	  <div class="col-md-6"> 
			...
			<a href="{{$user->generate_slug()}}" target="_blank" class="button "><i class="sl sl-icon-eye"> </i>Consulter ma page</a></center>
	  </div>
	  <div class="col-md-6"> 
	  	<center>
