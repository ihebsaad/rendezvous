...
echo "null";
  ...
  exit();
    ...
    $sql = "INSERT INTO payments (user, details, beneficiaire, beneficiaire_id, montant) VALUES ('".$iduser."', 'paiement d'une tranche de l'abonnement mensuel : N°: ".$numAbn."', 'prenezunrendezvous.com', '1', '".($event->data->object->amount_paid)."')";
if ($conn->query($sql) === TRUE) {
