...
echo "null";
  ...
  exit();
    ...
    $sql = "INSERT INTO payments (user, details, beneficiaire, beneficiaire_id, montant) VALUES ('".$iduser."', 'paiement d une tranche de l abonnement mensuel : N°: ".$numAbn."', 'prenezunrendezvous.com', '1', '".(floatval($event->data->object->amount_paid)/100)."')";
if ($conn->query($sql) === TRUE) {
